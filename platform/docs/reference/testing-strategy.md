...
[`docs/end-to-end-local-runbook.md`](./end-to-end-local-runbook.md) in this
repo,
[runtime repo `docs/end-to-end-local-runbook.md`](https://github.com/kmgrassi/parallel-agent-runtime/blob/main/docs/end-to-end-local-runbook.md),
and
[runtime repo `docs/local-e2e-testing.md`](https://github.com/kmgrassi/parallel-agent-runtime/blob/main/docs/local-e2e-testing.md).
For unit-test setup in the platform API see
[`apps/api/docs/TESTING.md`](../../apps/api/docs/TESTING.md).

> **Mirrored.** This doc also lives in the runtime repo at
> [`docs/testing-strategy.md`](https://github.com/kmgrassi/parallel-agent-runtime/blob/main/docs/testing-strategy.md).
...
- **Live-DB-tagged tests:** `mix test --only live_db` runs a handful of
  typed-Ecto smoke queries against real Supabase. Needs `SUPABASE_POOLER` in
  the env. Safe to run frequently — reads only.
...
- [ ] Add an **ALB health-check path** to the orchestrator's Terraform. The
      existing target group uses `/api/v1/state` ([main.tf:235](https://github.com/kmgrassi/parallel-agent-runtime/blob/main/apps/orchestrator/deploy/terraform/main.tf#L235));
...
- [runtime `docs/local-e2e-testing.md`](https://github.com/kmgrassi/parallel-agent-runtime/blob/main/docs/local-e2e-testing.md)
  — manual local E2E (Linear + Codex path, in-memory API tracker path).
- [`docs/end-to-end-local-runbook.md`](./end-to-end-local-runbook.md) —
  5-minute quickstart for all four services (platform copy).
- [runtime `apps/orchestrator/WORKFLOW.local-e2e.md`](https://github.com/kmgrassi/parallel-agent-runtime/blob/main/apps/orchestrator/WORKFLOW.local-e2e.md)
  — minimal smoke workflow definition.
- [runtime `apps/orchestrator/deploy/aws.md`](https://github.com/kmgrassi/parallel-agent-runtime/blob/main/apps/orchestrator/deploy/aws.md)
  — AWS deployment specifics.
- [`apps/api/docs/TESTING.md`](../../apps/api/docs/TESTING.md) — vitest
