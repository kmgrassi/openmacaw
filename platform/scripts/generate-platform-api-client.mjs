...
const contractsPath = resolve(root, "contracts/platform-api-contracts.ts");
...
for (const contractName of requiredContracts) {
  if (!contractsSource.includes(`${contractName}:`)) {
    throw new Error(`Missing PlatformApiContracts.${contractName}`);
  }
}

const generated = `// Generated from contracts/platform-api-contracts.ts. Do not edit by hand.
...
if (checkOnly) {
  ...
  if (current !== generated) {
    throw new Error(
      "Generated Platform API client is out of date. Run pnpm run platform-api-client:generate.",
    );
  }
} else {
