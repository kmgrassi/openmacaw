defmodule SymphonyElixir.Tracker.Linear do
  ...
  def fetch_issues_by_states(_workspace_id, states), do: fetch_issues_by_states(states)
  ...
  @spec update_issue_state(String.t() | SymphonyElixir.WorkItem.t(), String.t()) :: :ok | {:error, term()}
  def update_issue_state(%SymphonyElixir.WorkItem{id: id}, state_name),
    do: update_issue_state(id, state_name)
  ...
  @spec update_issue_state(String.t(), String.t() | SymphonyElixir.WorkItem.t(), String.t()) :: :ok | {:error, term()}
