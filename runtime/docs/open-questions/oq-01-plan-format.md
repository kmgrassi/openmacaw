...
```jsonc
{
  ...
  "input_schema": {
    ...
    "properties": {
      ...
      "default_runner": { "type": "string", "enum": ["codex", "openclaw", "computer_use", "openai_compatible"] },
      ...
      "tasks": {
        ...
        "items": {
          ...
          "properties": {
            ...
            "completion_gates": { "type": "array", "items": { "type": "string", "enum": ["lint", "tests", "peer_review", "self_review"] } }
          }
        }
      }
    }
