...
- `completionGates?: Array<"lint" | "tests" | "peer-review" | "self-review">`
  ...
  it.
- No persistent context surface that lets users or agents shape future
  runs over time.
...
- [ ] **4.1 Self-review lifecycle state** — _no scope doc yet_
- [ ] **4.2 Peer-review dispatch** — adjacent: [manager-as-regular-agent-scope](https://github.com/kmgrassi/parallel-agent-platform/blob/main/docs/active/manager-as-regular-agent-scope.md), [runtime companion](https://github.com/kmgrassi/parallel-agent-runtime/blob/main/docs/manager-as-regular-agent-runtime-scope.md)
