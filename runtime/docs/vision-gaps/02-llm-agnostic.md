...
- [ ] **2.1 Per-task model overrides via labels / plan metadata** — open question [oq-04](https://github.com/kmgrassi/parallel-agent-platform/blob/main/docs/open-questions/oq-04-per-task-model-overrides-credentials.md) · PR plan [oq-04-credentials-pr-plan](https://github.com/kmgrassi/parallel-agent-platform/blob/main/docs/reference/oq-04-credentials-pr-plan.md)
- [ ] **2.2 Execution adapters for credential-only providers** — scope: [provider-execution-adapter-rollout-scope](https://github.com/kmgrassi/parallel-agent-platform/blob/main/docs/active/provider-execution-adapter-rollout-scope.md)
